/*
 * @Author: Divenire
 * @Date: 2021-10-16 13:49:21
 * @LastEditors: Divenire
 * @LastEditTime: 2021-10-16 15:13:19
 * @Description: Ceres使用计算数值微分的方式拟合曲线
 *               在我的机器上I7-8750h 耗时4.24ms
 */
#include <iostream>
...
int main()
{
    ...
    for (int i = 0; i < N; ++i)
    {
        ...
        ceres::CostFunction *cost_function =
            new ceres::NumericDiffCostFunction<CURVE_FITTING_COST,ceres::CENTRAL, 1, 3>(
